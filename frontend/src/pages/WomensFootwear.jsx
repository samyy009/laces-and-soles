...
export default function WomensFootwear() {
  ...
  const filteredProducts = allProducts.filter(p => {
    const isWomen = p.category && p.category.toLowerCase() === 'women';
    const brandMatch = activeBrand === 'All' || p.brand === activeBrand;
    const priceMatch = p.price <= maxPrice;
    return isWomen && brandMatch && priceMatch;
  });
          ...
          <div className="flex-1">
             <div className="mb-8">
                ...
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-3 max-w-xl">
                  DISCOVER THE ULTIMATE COLLECTION OF WOMEN'S SNEAKERS. ENGINEERED FOR PERFORMANCE AND STYLE.
                </p>
             </div>
