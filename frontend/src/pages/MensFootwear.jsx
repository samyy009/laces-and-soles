...
export default function MensFootwear() {
  ...
  const filteredProducts = allProducts.filter(p => {
    const isMen = p.category && p.category.toLowerCase() === 'men';
    const brandMatch = activeBrand === 'All' || p.brand === activeBrand;
    const priceMatch = p.price <= maxPrice;
    return isMen && brandMatch && priceMatch;
  });
          ...
          <div className="flex-1">
             <div className="mb-8">
                ...
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-3 max-w-xl">
                  DISCOVER THE ULTIMATE COLLECTION OF MEN'S SNEAKERS. ENGINEERED FOR PERFORMANCE AND STYLE.
                </p>
             </div>
